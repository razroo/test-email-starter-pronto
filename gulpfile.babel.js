...
gulp.task('build',
  gulp.series(clean, pages, scss, images, inline));
...
function pages() {
  return src(['src/pages/**/*.html', '!src/pages/archive/**/*.html'])
    .pipe(panini({
      root: 'src/pages',
      layouts: 'src/layouts',
...
function images() {
  return src(['src/assets/img/**/*', '!src/assets/img/archive/**/*'])
    .pipe(imagemin())
...
function watch() {
  ...
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss']).on('all', gulp.series(resetPages, scss, pages, inline, browser.reload));
...
function zip() {
  ...
  var moveTasks = htmlFiles.map(function(file){
    ...
    var moveHTML = src(sourcePath)
      .pipe($.rename(function (path) {
        path.dirname = fileName;
        return path;
      }));

    var moveImages = src(sourcePath)
